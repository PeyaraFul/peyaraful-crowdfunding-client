      ...
      <div className="w-full max-w-md rounded-2xl border border-peyara-accent bg-white p-8 shadow-lg">
        ...
        <div className="mt-6">
          ...
          <button
            type="button"
            disabled
            className="mt-4 w-full rounded-lg border border-gray-300 py-2.5 font-semibold text-gray-400 transition cursor-not-allowed opacity-60 flex items-center justify-center gap-2"
          >
